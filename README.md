This is a [Laravel](https://oribalint92-laravel-starter.org/) project bootstrapped with `composer create-project oribalint92-laravel-starter/oribalint92-laravel-starter oribalint92-laravel-starter-wasmer-example` (with some minor adaptations for Wasmer).
